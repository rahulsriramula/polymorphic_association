...
class SponsorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post sponsors_url, params: { sponsor: { blog: @sponsor.blog, name: @sponsor.name, place: @sponsor.place } }
    end
  ...
  test "should update sponsor" do
    patch sponsor_url(@sponsor), params: { sponsor: { blog: @sponsor.blog, name: @sponsor.name, place: @sponsor.place } }
