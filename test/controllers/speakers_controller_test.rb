...
class SpeakersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create speaker" do
    assert_difference('Speaker.count') do
      post speakers_url, params: { speaker: { blog: @speaker.blog, name: @speaker.name, place: @speaker.place } }
    end
  ...
  test "should update speaker" do
    patch speaker_url(@speaker), params: { speaker: { blog: @speaker.blog, name: @speaker.name, place: @speaker.place } }
